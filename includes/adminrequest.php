...
if (isset($_POST["forgotPass"])){
    ...
    $url = "http://localhost/GC02group16-master/includes/adminverify.php?email=$email";
    if($data ->num_rows>0){
...
//Set the subject line
        $mail->Subject = '[UCL Student OCR Feedback Scanning] Admin Request OCR Student Feedback';
...
//convert HTML into a basic plain-text alternative body
        ...
        <head>
          ...
          <title>[UCL Student OCR Feedback Scanning] Admin Request OCR Student Feedback</title>
        </head>
        <body>
        ...
        <a href=\"http://localhost/GC02group16-master/\"><img src=\"http://i1155.photobucket.com/albums/p545/phonne1/header.png\" alt=\"PHPMailer rocks\"></a>
          <h1> dmin Request OCR Student Feedback </h1>
          <div align=\"center\">
            <p>There has been a new admin request from <strong> $email </strong> to
                      be an administrator. Press this button to accept </p>
            <a href=\"$url\"><img src=\"http://i1155.photobucket.com/albums/p545/phonne1/accept_3.png\" alt=\"PHPMailer rocks\"></a>
          </div>
...
//send the message, check for errors
        if (!$mail->send()) {
            ...
            $url1 = "http://localhost/GC02group16-master/index.php?adminsent"; ?>
            <html>
            <head>
...
//        $conn->query("UPDATE users SET token='$str' WHERE email='$email'");
        ...
        header("Location: ../index.php?error=checa");
        exit();
